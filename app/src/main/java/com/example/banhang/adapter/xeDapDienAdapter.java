...
import com.example.banhang.Interface.ItemClickListener;
...
public class xeDapDienAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ...
    public xeDapDienAdapter(Context context, List<SanPhamMoi> array) {
